...
void Vehicle::update(const float deltaTime)
{
	...
	// set the current position for the drawablegameobject
...
void Vehicle::getDirection(Vector2D position)
{
	m_direction = (m_currentPosition - position) * m_currentSpeed;
